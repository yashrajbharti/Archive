...
(function () {
  const elmtheclick = document.querySelector(".logo-main");
...
function vanish() {
  ...
  document.getElementById("moving-logo").classList.add("moveTopLeft");
  document.querySelector(".logo-main").click();
  document.querySelector(".outline").classList.add("text-line");
}
